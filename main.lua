...
local function teleportPlayerToMainSpawn(player)
  ...
  -- Add some effects on the player
  player:AddEntityEffect(cEntityEffect.effSpeed         ,  60 * 20, 2) -- Gives speed 2 for 60 secs
  player:AddEntityEffect(cEntityEffect.effResistance    ,  60 * 20, 2) -- Gives resistance 2 for 60 secs
  player:AddEntityEffect(cEntityEffect.effAbsorption    ,  60 * 20, 2) -- Gives absorption 2 for 60 secs
  player:AddEntityEffect(cEntityEffect.effFireResistance, 120 * 20, 2) -- Gives fire resistance 2 for 120 secs
  player:AddEntityEffect(cEntityEffect.effWaterBreathing, 120 * 20, 2) -- Gives water breathing 2 for 120 secs
end
